...
{
    public function setAttributeSetId(int $id): ActionData
    {
        return $this->setData(MetaProvider::PARAM_ATTRIBUTE_SET_ID, $id);
    }

    public function getAttributeSetId(): int
    {
        return (int)$this->getData(MetaProvider::PARAM_ATTRIBUTE_SET_ID);
    }
}
