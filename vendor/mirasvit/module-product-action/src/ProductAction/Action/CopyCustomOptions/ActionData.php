...
class ActionData extends GenericActionData
{
    ...
    public function setIsReplaceOptions(bool $flag): ActionData
    {
        return $this->setData(MetaProvider::PARAM_IS_REPLACE_OPTIONS, $flag);
    }

    public function getIsReplaceOptions(): bool
    {
        return (bool)$this->getData(MetaProvider::PARAM_IS_REPLACE_OPTIONS);
    }
}
