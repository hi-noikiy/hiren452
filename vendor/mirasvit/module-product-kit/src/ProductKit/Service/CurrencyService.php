...
class CurrencyService extends AbstractHelper
{
    /**
     * @var CurrencyHelper
     */
    ...
    /**
     * @param float                                     $amount
     * @param Currency|AbstractModel|string             $fromCurrency
     * @param Currency|string                           $toCurrency
     * @param int|\Magento\Framework\App\ScopeInterface $store
     *
     * @return float
     */
    ...
    /**
     * @param float                  $amount
     * @param Currency|AbstractModel $fromCurrency
