 ...
 */
namespace FME\Mediaappearance\Model\Media;
...
class ConfigPhotogallery implements PhotogalleryConfigInterface
{
    ...
    {
        return $this->storeManager->getStore()->getBaseUrl(\Magento\Framework\UrlInterface::URL_TYPE_MEDIA) . 'mediaappearance/files';
    }
