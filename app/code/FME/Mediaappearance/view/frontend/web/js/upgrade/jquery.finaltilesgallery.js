                    ...
                    //alert("Hello3");
                      //  if (true) {
                        ////alert("Inside Plugin");
                         ...
                         // //alert(instance.currentPage);
                        
                         // //alert();
                         //children().length
                        //$.get(instance.settings.autoLoadURL, { page: ++instance.currentPage, tabid: instance.$element.find(".ftg-filters").children(".selected").attr("gal-id"),child:instance.$element.find(".ftg-items .ftg-loaded").children().length }, function (html) {
                    ////alert(instance.settings.autoLoadURL);
                    if ($(".tab").length > 0) {
                        ...
                        //alert($(".ftg-items .ftg-loaded").length);
                        //$.get(instance.settings.autoLoadURL, { page: ++instance.currentPage, child:instance.$element.find(".ftg-items .ftg-loaded").children().length }, function (html) {
