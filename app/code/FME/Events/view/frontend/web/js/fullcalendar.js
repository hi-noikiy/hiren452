            ...
            var dragListener = this.segResizeListener = new HitDragListener(this, {
                ...
                hitOver: function (hit, isOrig, origHit) {
                    ...
                    if (resizeLocation) {
                        ...
                        else if (resizeLocation.start.isSame(event.start.clone().stripZone()) &&
...
// A defined `.eventProps`, even when empty, indicates that an event should be created.
    function getDraggedElMeta(el)
    {
        ...
        if (eventProps) {
            ...
            if (startTime == null) {
                startTime = eventProps.time; } // accept 'time' as well
        ...
        if (startTime == null) {
            startTime = el.data(prefix + 'time'); } // accept 'time' as well
        if (duration == null) {
...
----------------------------------------------------------------------------------------------------------------------*/
    ...
    // Is asychronous and returns a promise.
     ...
     // clear the content first
                return (
                _this.displaying =
                    syncThen(_this.displayView(date), function () {
    ...
    var ListViewGrid = Grid.extend({
        ...
        spanToSegs: function (span) {
            ...
            while (dayStart < view.end) {
                ...
                if (seg && !seg.isEnd && span.end.hasTime() &&
