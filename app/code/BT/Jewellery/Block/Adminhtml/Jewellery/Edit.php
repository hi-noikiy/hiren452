...
namespace BT\Jewellery\Block\Adminhtml\Jewellery;
...
class Edit extends \Magento\Backend\Block\Widget\Form\Container
{
    ...
    {
        $this->_objectId = 'id';
        $this->_controller = 'adminhtml_jewellery';
        $this->_blockGroup = 'BT_Jewellery';
    ...
    {
        $item = $this->_coreRegistry->registry('jewellery');
        if ($item->getId()) {
