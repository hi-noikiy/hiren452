...
namespace BT\Jewellery\Block\Adminhtml\Jewellery\Edit\Tab;
...
class Main extends Generic implements TabInterface
{
    ...
    public function __construct(
        ...
        \BT\Jewellery\Model\Status $status,
        \BT\Jewellery\Model\Type $type,
        array $data = []
    ) {
        $this->_type = $type;
        $this->_status = $status;
    ...
    {
        $model = $this->_coreRegistry->registry('jewellery');
        /** @var \Magento\Framework\Data\Form $form */
        $form = $this->_formFactory->create();
        $form->setHtmlIdPrefix('jewellery_');
        ...
        $fieldset->addField(
            'type',
            'select',
            ['name' => 'type', 'label' => __('Type'), 'title' => __('Type'),  'values' => $this->getTypesOption()]
        );
    ...
    protected function getTypesOption()
    {
        $collection = $this->_type->toOptionArray();
        foreach ($collection as $type) {
            $result[] = $type;
        }
        return $result;
