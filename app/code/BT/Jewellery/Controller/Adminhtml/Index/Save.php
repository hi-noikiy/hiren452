...
/**
 * Class Save
 * @package BT\Jewellery\Controller\Adminhtml\Index
...
class Save extends \Magento\Backend\App\Action //implements HttpPostActionInterface
{
    ...
    public function __construct(
        ...
        \BT\Jewellery\Model\ImageUploader $imageuploader,
        \BT\Jewellery\Model\JewelleryFactory $jewelleryFactory,
        \Magento\Backend\Model\Session $session
    ) {
        $this->session = $session;
        $this->jewelleryFactory = $jewelleryFactory;
    ...
    public function execute()
    {
        ...
        if ($data) {
            $model = $this->jewelleryFactory->create();
            ...
            try {
                ...
                $this->messageManager->addSuccess(__('You saved this Jewellery.'));
