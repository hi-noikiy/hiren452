            ...
            if ($params['purchaseref'] != '') {
                ...
                if (strpos($params['purchaseref'], '-') !== false) {
                        ...
                        if ($sizeofArr > 1) {
                            ...
                            if ($order->getId()) {
                                ...
                                foreach ($installmentArrId as $installmentId) {
                                    ...
                                    $this->setInstallmentSuccessData($order, $partialPayment, $installment, $params['payid']);
                    ...
                    if ($params['status'] == '0') {
                        ...
                        if (array_key_exists("payid", $params)) {
                            $payment->setAdditionalInformation('tran_id', $params['payid']);
                        }
