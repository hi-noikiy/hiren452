...
class Edit extends \Magento\Backend\App\Action
{
    ...
    protected function _initAction()
    {
        ...
        $resultPage->setActiveMenu('Magento_Catalog::inventory')
            ->addBreadcrumb(__('Product Page PDF Builder'), __('Product Page PDF Builder'))
    ...
    public function execute()
    {
        ...
        if ($id) {
            ...
            $model->getConditions()->setFormName('productpagepdf_profile_form');
            $model->getConditions()->setJsFormObject(
                $model->getConditionsFieldSetId($model->getConditions()->getFormName())
            );
            $model->getActions()->setFormName('productpagepdf_profile_form');
        ...
        $this->coreRegistry->register('mgz_conditions_form_name', 'productpagepdf_profile_form');
