...
class Version extends \Plumrocket\Base\Block\Adminhtml\System\Config\Form\Version
{
     ...
     * @var string
     */
    protected $_wikiLink = 'http://wiki.plumrocket.com/Magento_2_Search_Autocomplete_and_Suggest_v1.x_Extension';

    /**
     * Full module name
     * @var string
     */
    protected $_moduleName = 'Search Autocomplete & Suggest';
}
