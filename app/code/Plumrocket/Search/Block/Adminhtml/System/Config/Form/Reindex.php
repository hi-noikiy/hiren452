...
class Reindex extends \Plumrocket\Base\Block\Adminhtml\System\Config\Form\Version
{
    /**
    ...
    public function render(\Magento\Framework\Data\Form\Element\AbstractElement $element)
    {
        return '<div style="padding:10px;background-color:#fff;border:1px solid #ddd;margin-bottom:7px;">' .
            __('Please note: to apply changes immediately after you saved configuration, make sure to reindex Catalog Search Index.')
            . '</div>' . $this->_getAdditionalInfoHtml();
    }
