...
/*==================== Theme 1 ====================*/
.newspopup-up-form.newspopup-theme .pr-inpopup{
    color: inherit;
...
.newspopup-up-form.newspopup-theme h3 {
  clear: both;
  font-size: 14px;
}

.newspopup-up-form.newspopup-theme .mailchimp_item {
  font-size: 13px;
}
...
.newspopup-up-form.newspopup-theme .integration_item_wrapper {
  order: 1;
}
...
/*==================== Theme 6 ====================*/
.newspopup-up-form.newspopup-theme .prgdpr-consent-checkbox{
    color: #e1e1e1;
}
...
.newspopup-up-form.newspopup-theme .integration_item_wrapper,
.newspopup-up-form.newspopup-theme .integration_item_wrapper h3 {
  color: #a7a7a7;
}

.newspopup-up-form.newspopup-theme .newspopup_up_bg_form .integration_item_wrapper select {
  color: #b0b0b0;
}
...
.newspopup-up-form.newspopup-theme ul+h3 {
  text-align: left;
}
...
.newspopup-up-form.newspopup-theme .newspopup_up_bg_form ul li.prrecaptcha-wrapper{
  width: 100%;
}
...
.newspopup-up-form.newspopup-theme .newspopup_up_bg_form .g-recaptcha{
  transform: scale(0.68);
}
...
.newspopup-up-form.newspopup-theme .newspopup_up_bg_form ul.integration_item_wrapper{
  order:1;
}
...
.newspopup-up-form.newspopup-theme .newspopup_up_bg_form .integration_item_wrapper input[type="radio"]{
    margin-top: 4px;
}

.newspopup-up-form.newspopup-theme .newspopup_up_bg_form .integration_item_wrapper input[type="radio"] + label{
    color: inherit;
    font-size: 12px;
}
...
.newspopup-up-form.newspopup-theme .integration_item_wrapper .newspopup_up_bg_form input[type="radio"]{
    margin-top: 4px;
}
