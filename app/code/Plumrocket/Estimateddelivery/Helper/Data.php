...
class Data extends Main
{
     ...
     * @return bool
     */
    public function isEnabledDefaultText(string $type): bool
    {
        return (bool) $this->getConfig($this->getConfigSectionId() . '/' . $type . '/default_text_enable');
    }
     ...
     * @return string
     */
    public function getDefaultText(string $type): string
    {
        return (string) $this->getConfig($this->getConfigSectionId() . '/' . $type . '/default_text');
    }
    ...
    public function showPosition($position)
    {
        if (null === $this->positions) {
            $this->positions = explode(',', $this->getConfig($this->_configSectionId.'/general/position'));
        }
    ...
    public function serialize($data)
    {
        if ($this->versionCheck()) {
            return serialize($data); // @TODO direct serialize is not allowed
        }
