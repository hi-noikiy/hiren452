...
namespace Plumrocket\AutoInvoiceShipment\Controller\Adminhtml\Shipmentrules;

class NewConditionHtml extends \Plumrocket\AutoInvoiceShipment\Controller\Adminhtml\Shipmentrules
{
    /**
     * Shipmentrules Factory
     *
    ...
    public function execute()
    {
        ...
        $model = $this->_objectManager->create(
            ...
            $this->shipmentrulesFactory->create()
        )->setPrefix(
            'conditions'
        );
        if (!empty($typeArr[1])) {
