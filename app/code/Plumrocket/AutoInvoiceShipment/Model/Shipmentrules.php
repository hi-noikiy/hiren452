...
/**
 * @method ShipmentrulesCollection getCollection()
 * @method int getCreateShipment()
 */
class Shipmentrules extends AbstractRules
{

    const CREATE_AFTER_ORDER_CREATED   = 1;
    const CREATE_AFTER_INVOICE_CREATED = 2;

    const DEFAULT_COMMENT = 'Shipment Created Automatically';
     ...
     * @var string
     */
    protected $_eventObject = 'shipmentrules';
    ...
    {
        $this->_init(\Plumrocket\AutoInvoiceShipment\Model\ResourceModel\Shipmentrules::class);
    }

    /**
     * @param null | int | array $websiteId
     * @return ShipmentrulesCollection
     */
    ...
    public function preValidate(Order $order, $skipValidCreateAfter)
    {
        ...
        if ($this->getCreateShipment() === self::CREATE_AFTER_INVOICE_CREATED) {
            $success = $skipValidCreateAfter || $order->hasInvoices();
        }
