...
namespace Plumrocket\AmpEmail\Plugin\MagentoTwoTwo;
...
class CsrfValidatorPlugin
{
     ...
     * @var string
     */
    private $ampInterface = '\Plumrocket\Amp\Model\MagentoTwoTwo\CsrfAwareActionInterface'; //@codingStandardsIgnoreLine
    ...
    {
        if ($action instanceof \Plumrocket\AmpEmailApi\Model\MagentoTwoTwo\CsrfAwareActionInterface
            || $action instanceof \Plumrocket\AmpEmail\Model\MagentoTwoTwo\CsrfAwareActionInterface
            || $action instanceof $this->ampInterface
        ) {
