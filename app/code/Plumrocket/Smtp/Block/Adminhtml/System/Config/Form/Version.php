...
class Version extends \Plumrocket\Base\Block\Adminhtml\System\Config\Form\Version
{
     ...
     * @var string
     */
    protected $_wikiLink = 'http://wiki.plumrocket.com/Magento_2_SMTP_v1.x_Extension';

    /**
     * Full module name
     * @var string
     */
    protected $_moduleName = 'SMTP';
            ...
            if (strpos($key, $pr) !== false
                ...
                if (method_exists($helper, $mt)) {
                    $mtv = $this->_scopeConfig->getValue(
                        $helper->$mt() . '/general/' . strrev('lai' . 'res'),
                ...
                $html .=
                    ...
                    $inpHN . 'products[' .  $n . '][]" value="'
                        . $this->escapeHtml((string)$module['setup_version']) . '" />' .
