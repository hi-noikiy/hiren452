...
namespace Splitit\PaymentGateway\Test\Unit\Observer;
...
use Splitit\PaymentGateway\Observer\DataAssignObserver;
...
class DataAssignObserverTest extends \PHPUnit_Framework_TestCase
{
    public function testExectute()
    {
        ...
        $dataObject = new DataObject(
            [
                'transaction_result' => SplititCreateApiImplementation::SUCCESS
            ]
        );
        ...
        $paymentInfoModel->expects(static::once())
            ...
            ->with(
                'transaction_result',
                SplititCreateApiImplementation::SUCCESS
            );
