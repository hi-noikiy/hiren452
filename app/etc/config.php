...
return [
    'modules' => [
        ...
        'Aumika_Military' => 1,
        'AuthorizeNet_Core' => 0,
        'AuthorizeNet_Centinel' => 0,
        'AuthorizeNet_CreditCard' => 0,
        'AuthorizeNet_ECheck' => 0,
        'AuthorizeNet_PayPalExpress' => 0,
        'AuthorizeNet_VisaCheckout' => 0,
        'AuthorizeNet_Webhooks' => 0,
        'Avada_Proofo' => 1,
        'BT_Homeslider' => 1,
        'BT_Jewellery' => 1,
        'BT_News' => 1,
        ...
        'Hiddentechies_Reviewspro' => 1,
        'JB_AumikaFramework' => 1,
        'JB_DynamicAttribute' => 1,
        'JB_HomeCategory' => 1,
        'JB_ProductPage' => 1,
        'Klarna_Core' => 1,
        ...
        'Mageants_OrderDelete' => 1,
        'Magedelight_Base' => 1,
        'Magedelight_Facebook' => 1,
        'Magefan_Community' => 1,
        'Magefan_Blog' => 1,
        ...
        'Magezon_Core' => 1,
        'Magezon_Builder' => 1,
        'Magezon_ProductPagePdf' => 1,
        'Magezon_SimpleBuilder' => 1,
        'Meetanshi_Inquiry' => 1,
        'Meetanshi_OrderNumber' => 1,
        'Meetanshi_Partialpro' => 1,
        'Meetanshi_Restrictuser' => 1,
        'Mirasvit_Banner' => 1,
        'Mirasvit_Core' => 1,
        ...
        'Mirasvit_SalesRule' => 1,
        'MyZillion_SimplifiedInsurance' => 1,
        'PHPCuong_Faq' => 1,
        'Plumrocket_Base' => 1,
        'Plumrocket_Ajaxcart' => 1,
        'Plumrocket_Token' => 1,
